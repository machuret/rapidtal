        ...
        <div className={s.content}>
          ...
          <section id="case-study">
            ...
            <div className={s.statsGrid}>
              <div className={s.statCard}><div className={s.statNumber}>+60</div><div className={s.statLabel}>Additional Students Enrolled</div></div>
              <div className={s.statCard}><div className={s.statNumber}>&lt;5 min</div><div className={s.statLabel}>Lead Response Time<br />(Was 24–48 Hours)</div></div>
              <div className={s.statCard}><div className={s.statNumber}>140%</div><div className={s.statLabel}>More Google Reviews</div></div>
              <div className={s.statCard}><div className={s.statNumber}>85%</div><div className={s.statLabel}>Increase in Organic Search Traffic</div></div>
              <div className={s.statCard}><div className={s.statNumber}>210%</div><div className={s.statLabel}>Increase in Social Media Engagement</div></div>
              <div className={s.statCard}><div className={s.statNumber}>3x</div><div className={s.statLabel}>Instagram Following Growth</div></div>
            </div>
          ...
          <section id="cost-comparison">
            ...
            <div className={s.tableWrap}>
              <table className={s.table}>
                <thead><tr><th>Option</th><th>Monthly Cost</th><th>What You Actually Get</th></tr></thead>
                <tbody>
                  ...
                  <tr className={s.tableRowHighlight}><td>RapidTal: 1 VA + Claude AI</td><td>$800 USD/mo + $20 USD Claude</td><td>Full-time, direct hire. All 10 functions. AI-powered. You own everything. No ongoing fees to us.</td></tr>
                </tbody>
              </table>
            </div>
