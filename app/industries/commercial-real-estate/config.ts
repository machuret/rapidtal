...
export const config: IndustryConfig = {
  ...
  cta: {
    tag: 'Get the blueprint — free',
    headingLine1: 'Book a 20-minute call. Walk away with your',
    headingLine2Before: `${industry}'s`,
    headingLine2Highlight: 'exact saving number',
    headingLine2After: '.',
    subhead:
      `We will model your specific office, show you the AI stack, and hand you the Offshore Marketing Ninja role blueprint — built for ${industry}s. Yours to keep, no strings attached.`,
    microCopy: 'No lock-in. No pitch deck. Just the numbers and the plan.',
    listHeading: 'What you get on the call',
    bullets: [
      "A live cost model built around your agency's salary levels and role count",
      `The exact AI tool stack for each ${industry} marketing role — with monthly costs`,
      'Role-specific standard operating procedures and prompt libraries for commercial real estate',
      'KPI frameworks for Facebook ads, SEO, social media and email — pre-built and ready to use',
      'A shortlist of matched, pre-vetted Offshore Marketing Ninjas ready to start within 14 days',
    ],
    buttonLabel: 'Book my free discovery call →',
    bookingHref: '#', // TODO: replace with real Calendly/HubSpot URL
    trustItems: [
