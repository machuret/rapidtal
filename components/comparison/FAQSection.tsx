...
const FAQS: FAQ[] = [
  ...
  },
  {
    ...
    answer: "You pay us one monthly invoice. We handle all Philippines payroll, tax compliance, and employment obligations. No international transfers, no currency risk, no admin burden on your end."
  },
  {
