...
const roles = [
  { slug: 'executive-assistant', component: 'HireExecutiveAssistantPage' },
  { slug: 'virtual-assistant', component: 'HireVirtualAssistantPage' },
  { slug: 'marketing-assistant', component: 'HireMarketingAssistantPage' },
  { slug: 'project-manager', component: 'HireProjectManagerPage' },
  { slug: 'data-entry-specialist', component: 'HireDataEntrySpecialistPage' },
  { slug: 'lead-generation-specialist', component: 'HireLeadGenerationSpecialistPage' },
  { slug: 'research-analyst', component: 'HireResearchAnalystPage' },
  { slug: 'customer-support-specialist', component: 'HireCustomerSupportSpecialistPage' },
  { slug: 'hubspot-administrator', component: 'HireHubSpotAdministratorPage' },
  { slug: 'operations-manager', component: 'HireOperationsManagerPage' }
];
...
console.log('\n🎉 All 10 operations page files created successfully!');
